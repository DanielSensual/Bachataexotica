...
export default function HomePage() {
  return (
    <section className="mx-auto max-w-5xl px-4 pb-24 pt-14 text-center">
      ...
      {/* ── Event Grid ─────────────────────────────────────────────── */}
      <div id="events" className="mt-20 grid gap-8 sm:grid-cols-2">
        ...
        <div className="flex flex-col items-start rounded-2xl border border-gold/30 bg-[#181818] px-6 py-8 shadow-lg">
          ...
          <div className="mb-2 font-bold text-gold">Dance Factory Tampa Bay</div>
        ...
        {/* Miami placeholder */}
        <div className="flex flex-col items-start rounded-2xl border border-gold/30 bg-[#181818] px-6 py-8 shadow-lg">
          <h2 className="mb-2 font-heading text-2xl text-gold">Miami Sensual Week</h2>
      ...
      <div className="mx-auto mt-24 rounded-xl bg-black/80 px-6 py-10 shadow-inner">
        <h3 className="mb-6 font-heading text-2xl text-gold">What Dancers Are Saying</h3>
        <div className="flex flex-col gap-8 sm:flex-row sm:gap-12">
          <blockquote className="flex-1 text-lg italic text-white/80">
            ...
            <footer className="mt-2 text-sm font-bold text-gold">— Jessica R.</footer>
          </blockquote>
          <blockquote className="flex-1 text-lg italic text-white/80">
            “Incredible instructors, real connection, and the parties are legendary.”
            <footer className="mt-2 text-sm font-bold text-gold">— Andre L.</footer>
          </blockquote>
        </div>
      </div>
    </section>
